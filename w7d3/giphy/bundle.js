...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    'ul',
    null,
    giphys.map(function (giphy, idx) {
      return _react2.default.createElement(_giphys_index_item2.default, { giphy: giphy, key: idx });
    })
  );
};
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('input', { id: 'search', type: 'text', onChange: this.handleChange }),
          _react2.default.createElement(
            'button',
...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  var api = 'http://api.giphy.com/v1/gifs/search?q=' + searchTerm + '&api_key=dc6zaTOxFJmzC&limit=2';
  return $.ajax({
    url: api,
    type: 'GET'
  });
